# 单纯按照 GHSV 分类，对比 simple power law 和加入 (1 - beta) 的两种形式
...
# 输出文件夹
OUT_DIR = Path("R_GHSV_cluster_improved")
...
def fit_one_ghsv_group(df_group, ghsv_value):
    ...
    make_single_parity_plot(
        ...
        title=f"Simple Power Law - MeOH, GHSV = {ghsv_label}",
        save_path=group_dir / f"GHSV_{ghsv_label}_simple_powerlaw_parity_meoh.png"
    )
    ...
    make_single_parity_plot(
        ...
        ylabel="Predicted CO",
        title=f"Simple Power Law - CO, GHSV = {ghsv_label}",
        save_path=group_dir / f"GHSV_{ghsv_label}_simple_powerlaw_parity_co.png"
    )
    ...
    make_single_parity_plot(
        ...
        xlabel="Experimental MeOH",
        ylabel="Predicted MeOH",
        title=f"Power Law with 1 - beta - MeOH, GHSV = {ghsv_label}",
        save_path=group_dir / f"GHSV_{ghsv_label}_with_1_minus_beta_parity_meoh.png"
    )
    ...
    make_single_parity_plot(
        ...
        xlabel="Experimental CO",
        ylabel="Predicted CO",
        title=f"Power Law with 1 - beta - CO, GHSV = {ghsv_label}",
        save_path=group_dir / f"GHSV_{ghsv_label}_with_1_minus_beta_parity_co.png"
    )
