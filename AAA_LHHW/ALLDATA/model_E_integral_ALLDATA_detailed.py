...
MODEL_NAME = "Global_detailed_integral_two_reaction_LHHW_ALLDATA_real_W_flow"

BASE_DIR = Path(__file__).resolve().parent

OUT_DIR = BASE_DIR / "output" / "global_detailed_integral_LHHW_ALLDATA_real_W_flow_detailed"
...
BOUNDS = [
    ...
    (-20.0, 10.0),       # ln_KCO2
    (-20.0, 15.0),       # ln_KCO, relaxed upper bound
...
def make_relative_error_vs_ghsv_plot(result_df, rel_error_col, title, save_path):
...
def fit_global_integral_model(df_group):
    ...
    print("\n" + "=" * 70)
    print("开始全局拟合 Global Detailed Integral LHHW")
    ...
    summary = {
        "model": MODEL_NAME,
        "fit_type": "global_all_GHSV_detailed_real_W_flow",
        "Tave": Tave,
...
def save_results(summary, params, result_df, group_metrics):
    ...
    summary_df.to_excel(OUT_DIR / "global_detailed_summary_detailed.xlsx", index=False)
    params_df.to_excel(OUT_DIR / "global_detailed_parameters_detailed.xlsx", index=False)
    result_df.to_excel(OUT_DIR / "global_detailed_predictions_detailed.xlsx", index=False)
    group_metrics.to_excel(OUT_DIR / "global_detailed_group_metrics_by_GHSV_detailed.xlsx", index=False)

    make_global_parity_plot(
        result_df=result_df,
        exp_col="rCH3OH",
        pred_col="rCH3OH_pred",
        title="Global Detailed Integral LHHW CH3OH",
        save_path=OUT_DIR / "parity_CH3OH_global_detailed.png",
    )
    ...
    make_global_parity_plot(
        ...
        exp_col="rCO",
        pred_col="rCO_pred",
        title="Global Detailed Integral LHHW CO",
        save_path=OUT_DIR / "parity_CO_global_detailed.png",
    )

    make_residual_vs_temperature_plot(
        result_df=result_df,
        residual_col="res_CH3OH",
        title="Global Detailed Integral LHHW CH3OH residual vs T",
        save_path=OUT_DIR / "residual_vs_T_CH3OH_global_detailed.png",
    )

    make_residual_vs_temperature_plot(
        result_df=result_df,
        residual_col="res_CO",
        title="Global Detailed Integral LHHW CO residual vs T",
        save_path=OUT_DIR / "residual_vs_T_CO_global_detailed.png",
    )

    make_residual_vs_ghsv_plot(
        result_df=result_df,
        residual_col="res_CH3OH",
        title="Global Detailed Integral LHHW CH3OH residual vs GHSV",
        save_path=OUT_DIR / "residual_vs_GHSV_CH3OH_global_detailed.png",
    )

    make_residual_vs_ghsv_plot(
        result_df=result_df,
        residual_col="res_CO",
        title="Global Detailed Integral LHHW CO residual vs GHSV",
        save_path=OUT_DIR / "residual_vs_GHSV_CO_global_detailed.png",
    )

    make_relative_error_vs_ghsv_plot(
        result_df=result_df,
        rel_error_col="rel_error_rCH3OH_%",
        title="Global Detailed Integral LHHW CH3OH relative error vs GHSV",
        save_path=OUT_DIR / "relative_error_vs_GHSV_CH3OH_global_detailed.png",
    )

    make_relative_error_vs_ghsv_plot(
        result_df=result_df,
        rel_error_col="rel_error_rCO_%",
        title="Global Detailed Integral LHHW CO relative error vs GHSV",
        save_path=OUT_DIR / "relative_error_vs_GHSV_CO_global_detailed.png",
    )
...
def main():
    ...
    print("\n=======================================================")
    print("Global detailed integral LHHW fitting with real W/flow")
    print("=======================================================")
