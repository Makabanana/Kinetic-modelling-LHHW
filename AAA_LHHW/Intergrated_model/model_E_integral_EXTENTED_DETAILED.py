...
# 模型名称
MODEL_NAME = "Model_E_integral_two_reaction_LHHW_DE_detailed_E"

# 当前脚本所在文件夹
BASE_DIR = Path(__file__).resolve().parent

# 输出文件夹
OUT_DIR = BASE_DIR / "output" / "model_E_integral_DE_detailed_E"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# 总 experiment log
EXPERIMENT_LOG_PATH = BASE_DIR / "output" / "experiment_log_E.csv"
